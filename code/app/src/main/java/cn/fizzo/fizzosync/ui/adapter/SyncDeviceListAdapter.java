...
public class SyncDeviceListAdapter extends BaseAdapter {
    ...
    private List<SyncDeviceEntity> mData;

    public SyncDeviceListAdapter(Context context, List<SyncDeviceEntity> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SyncDeviceEntity traineeRE = mData.get(position);

        holder.tvName.setText("(" + traineeRE.trainee.hrdevicenumber + ")" + traineeRE.trainee.name);
        holder.tvWatchMac.setText(traineeRE.trainee.macaddr);
